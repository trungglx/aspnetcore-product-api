...
public class ProductControllerTests
{
    ...
    public async Task Get_ReturnsAllProducts()
    {
        ...
        {
            new Product { Id = 1, Name = "Táo", Price = 10000 }
        };
    ...
    {
        var product = new Product { Id = 1, Name = "Nho", Price = 12000 };
        ...
        Assert.Equal("Nho", returnProduct.Name);
    }
    ...
    {
        var input = new Product { Name = "Mít", Price = 13000 };
        var saved = new Product { Id = 1, Name = "Mít", Price = 13000 };
        ...
        Assert.Equal("Mít", returnProduct.Name);
    }

    [Fact]
    public async Task Update_ReturnsOk_WhenProductExists()
    {
        var updated = new Product { Id = 1, Name = "Xoài", Price = 20000 };
        ...
        var okResult = Assert.IsType<OkObjectResult>(result);
        var returnProduct = Assert.IsType<Product>(okResult.Value);
        Assert.Equal("Xoài", returnProduct.Name);
    }

    [Fact]
    public async Task Update_ReturnsNotFound_WhenNotExist()
    {
        var updated = new Product { Id = 99, Name = "Dưa", Price = 15000 };
